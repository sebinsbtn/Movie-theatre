...
Public Class ticketres
    ...
    Private Sub ticketres_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        con.Open()
        Dim ct As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f1]= -1 "
        Dim ct1 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f2]= -1 "
        Dim ct2 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f3]= -1 "
        Dim ct3 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f4]= -1 "
        Dim ct4 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f5]= -1 "
        Dim ct5 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f6]= -1 "
        Dim ct6 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f7]= -1 "
        Dim ct7 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f8]= -1 "
        Dim ct8 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f9]= -1 "
        Dim ct9 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f10]= -1 "
        Dim ct10 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f11]= -1 "
        Dim ct11 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f12]= -1 "
        Dim ct12 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f13]= -1 "
        Dim ct13 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f14]= -1 "
        Dim ct14 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f15]= -1 "
        Dim ct15 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f16]= -1 "
        Dim ct16 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f17]= -1 "
        Dim ct17 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f18]= -1 "
        Dim ct18 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f19]= -1 "
        Dim ct19 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f20]= -1 "
        Dim ct20 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f21]= -1 "
        Dim ct21 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f22]= -1 "
        Dim ct22 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f23]= -1 "
        Dim ct23 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f24]= -1 "
        Dim ct24 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f25]= -1 "
        Dim ct25 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f26]= -1 "
        Dim ct26 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f27]= -1 "
        Dim ct27 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f28]= -1 "
        Dim ct28 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f29]= -1 "
        Dim ct29 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f30]= -1 "
        Dim ct30 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f31]= -1 "
        Dim ct31 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f32]= -1 "
        Dim ct32 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f33]= -1 "
        Dim ct33 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f34]= -1 "
        Dim ct34 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f35]= -1 "
        Dim ct35 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f36]= -1 "
        Dim ct36 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f37]= -1 "
        Dim ct37 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f38]= -1 "
        Dim ct38 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f39]= -1 "
        Dim ct39 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f40]= -1 "
        Dim ct40 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f41]= -1 "
        Dim ct41 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f42]= -1 "
        Dim ct42 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f43]= -1 "
        Dim ct43 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f44]= -1 "
        Dim ct44 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f45]= -1 "
        Dim ct45 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f46]= -1 "
        Dim ct46 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f47]= -1 "
        Dim ct47 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f48]= -1 "
        Dim ct48 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f49]= -1 "
        Dim ct49 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f50]= -1 "
        Dim ct50 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f51]= -1 "
        Dim ct51 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f52]= -1 "
        Dim ct52 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f53]= -1 "
        Dim ct53 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f54]= -1 "
        Dim ct54 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f55]= -1 "
        Dim ct55 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f56]= -1 "
        Dim ct56 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f57]= -1 "
        Dim ct57 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f58]= -1 "
        Dim ct58 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f59]= -1 "
        Dim ct59 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f60]= -1 "
        Dim ct60 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f61]= -1 "
        Dim ct61 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f62]= -1 "
        Dim ct62 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f63]= -1 "
        Dim ct63 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f64]= -1 "
        Dim ct64 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f65]= -1 "
        Dim ct65 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f66]= -1 "
        Dim ct66 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f67]= -1 "
        Dim ct67 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f68]= -1 "
        Dim ct68 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f69]= -1 "
        Dim ct69 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f70]= -1 "
        Dim ct70 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f71]= -1 "
        Dim ct71 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f72]= -1 "
        Dim ct72 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f73]= -1 "
        Dim ct73 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f74]= -1 "
        Dim ct74 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f75]= -1 "
        Dim ct75 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f76]= -1 "
        Dim ct76 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f77]= -1 "
        Dim ct77 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f78]= -1 "
        Dim ct78 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f79]= -1 "
        Dim ct79 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f80]= -1 "
        Dim ct80 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f81]= -1 "
        Dim ct81 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f82]= -1 "
        Dim ct82 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f83]= -1 "
        Dim ct83 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f84]= -1 "
        Dim ct84 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f85]= -1 "
        Dim ct85 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f86]= -1 "
        Dim ct86 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f87]= -1 "
        Dim ct87 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f88]= -1 "
        Dim ct88 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f89]= -1 "
        Dim ct89 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f90]= -1 "
        Dim ct90 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f91]= -1 "
        Dim ct91 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f92]= -1 "
        Dim ct92 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f93]= -1 "
        Dim ct93 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f94]= -1 "
        Dim ct94 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f95]= -1 "
        Dim ct95 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f96]= -1 "
        Dim ct96 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f97]= -1 "
        Dim ct97 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f98]= -1 "
        Dim ct98 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f99]= -1 "
        Dim ct99 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f100]= -1 "
        Dim ct100 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f101]= -1 "
        Dim ct101 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f102]= -1 "
        Dim ct102 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f103]= -1 "
        Dim ct103 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f104]= -1 "
        Dim ct104 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f105]= -1 "
        Dim ct105 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f106]= -1 "
        Dim ct106 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f107]= -1 "
        Dim ct107 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f108]= -1 "
        Dim ct108 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f109]= -1 "
        Dim ct109 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f110]= -1 "
        Dim ct110 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f111]= -1 "
        Dim ct111 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [f112]= -1 "
        Dim ct112 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s1]= -1 "
        Dim ct113 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s2]= -1 "
        Dim ct114 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s3]= -1 "
        Dim ct115 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s4]= -1 "
        Dim ct116 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s5]= -1 "
        Dim ct117 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s6]= -1 "
        Dim ct118 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s7]= -1 "
        Dim ct119 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s8]= -1 "
        Dim ct120 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s9]= -1 "
        Dim ct121 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s10]= -1 "
        Dim ct122 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s11]= -1 "
        Dim ct123 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s12]= -1 "
        Dim ct124 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s13]= -1 "
        Dim ct125 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s14]= -1 "
        Dim ct126 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s15]= -1 "
        Dim ct127 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s16]= -1 "
        Dim ct128 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s17]= -1 "
        Dim ct129 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s18]= -1 "
        Dim ct130 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s19]= -1 "
        Dim ct131 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s20]= -1 "
        Dim ct132 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s21]= -1 "
        Dim ct133 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s22]= -1 "
        Dim ct134 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s23]= -1 "
        Dim ct135 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s24]= -1 "
        Dim ct136 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s25]= -1 "
        Dim ct137 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s26]= -1 "
        Dim ct138 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s27]= -1 "
        Dim ct139 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s28]= -1 "
        Dim ct140 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s29]= -1 "
        Dim ct141 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s30]= -1 "
        Dim ct142 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s31]= -1 "
        Dim ct143 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s32]= -1 "
        Dim ct144 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s33]= -1 "
        Dim ct145 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s34]= -1 "
        Dim ct146 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s35]= -1 "
        Dim ct147 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s36]= -1 "
        Dim ct148 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s37]= -1 "
        Dim ct149 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s38]= -1 "
        Dim ct150 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s39]= -1 "
        Dim ct151 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s40]= -1 "
        Dim ct152 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s41]= -1 "
        Dim ct153 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s42]= -1 "
        Dim ct154 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s43]= -1 "
        Dim ct155 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s44]= -1 "
        Dim ct156 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s45]= -1 "
        Dim ct157 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s46]= -1 "
        Dim ct158 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s47]= -1 "
        Dim ct159 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [s48]= -1 "
        Dim ct160 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b1]= -1 "
        Dim ct161 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b2]= -1 "
        Dim ct162 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b3]= -1 "
        Dim ct163 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b4]= -1 "
        Dim ct164 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b5]= -1 "
        Dim ct165 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b6]= -1 "
        Dim ct166 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b7]= -1 "
        Dim ct167 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b8]= -1 "
        Dim ct168 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b9]= -1 "
        Dim ct169 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b10]= -1 "
        Dim ct170 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b11]= -1 "
        Dim ct171 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b12]= -1 "
        Dim ct172 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b13]= -1 "
        Dim ct173 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b14]= -1 "
        Dim ct174 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b15]= -1 "
        Dim ct175 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b16]= -1 "
        Dim ct176 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b17]= -1 "
        Dim ct177 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b18]= -1 "
        Dim ct178 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b19]= -1 "
        Dim ct179 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b20]= -1 "
        Dim ct180 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b21]= -1 "
        Dim ct181 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b22]= -1 "
        Dim ct182 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b23]= -1 "
        Dim ct183 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b24]= -1 "
        Dim ct184 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b25]= -1 "
        Dim ct185 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b26]= -1 "
        Dim ct186 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b27]= -1 "
        Dim ct187 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b28]= -1 "
        Dim ct188 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b29]= -1 "
        Dim ct189 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b30]= -1 "
        Dim ct190 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b31]= -1 "
        Dim ct191 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b32]= -1 "
        Dim ct192 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b33]= -1 "
        Dim ct193 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b34]= -1 "
        Dim ct194 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b35]= -1 "
        Dim ct195 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b36]= -1 "
        Dim ct196 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b37]= -1 "
        Dim ct197 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b38]= -1 "
        Dim ct198 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b39]= -1 "
        Dim ct199 As String = "select * from [reservetab] where resDate=#" & TextBox3.Text & "# AND [b40]= -1 "
    ...
    Private Sub Button201_Click(sender As Object, e As EventArgs) Handles Button201.Click
        ...
        If Form3.checkreserve = 1 Then
            balcony = balcony + rdr.GetValue(1)
            first = first + rdr.GetValue(9)
            second = second + rdr.GetValue(17)
            Dim co1 As String = "update [DCR] set [balcony1] = '" & balcony & "',[firstclass1] = '" & first & "',[second class1] = '" & second & "' where [currdate]=#" & TextBox3.Text & "#"
            cmd = New OleDbCommand(co1)
        Else
            balcony = balcony + rdr.GetValue(5)
            first = first + rdr.GetValue(13)
            second = second + rdr.GetValue(21)
            Dim co2 As String = "update [DCR] set [balcony11] = '" & balcony & "',[firstclass11] = '" & first & "',[second class11] = '" & second & "' where [currdate]=#" & TextBox3.Text & "#"
        ...
        If Button1.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f1] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button2.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f2] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button3.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f3] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button4.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f4] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button5.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f5] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button6.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f6] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button7.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f7] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button8.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f8] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button9.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f9] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button10.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f10] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button11.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f11] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button12.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f12] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button13.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f13] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button14.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f14] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button15.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f15] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button16.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f16] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button17.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f17] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button18.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f18] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button19.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f19] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button20.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f20] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button21.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f21] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button22.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f22] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button23.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f23] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button24.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f24] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button25.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f25] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button26.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f26] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button27.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f27] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button28.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f28] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button29.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f29] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button30.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f30] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button31.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f31] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button32.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f32] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button33.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f33] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button34.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f34] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button35.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f35] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button36.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f36] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button37.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f37] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button38.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f38] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button39.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f39] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button40.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f40] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button41.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f41] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button42.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f42] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button43.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f43] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button44.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f44] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button45.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f45] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button46.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f46] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button47.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f47] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button48.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f48] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button49.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f49] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button50.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f50] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button51.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f51] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button52.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f52] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button53.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f53] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button54.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f54] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button55.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f55] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button56.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f56] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button57.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f57] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button58.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f58] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button59.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f59] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button60.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f60] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button61.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f61] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button62.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f62] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button63.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f63] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button64.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f64] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button65.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f65] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button66.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f66] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button67.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f67] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button68.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f68] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button69.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f69] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button70.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f70] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button71.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f71] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button72.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f72] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button73.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f73] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button74.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f74] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button75.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f75] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button76.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f76] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button77.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f77] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button78.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f78] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button79.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f79] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button80.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f80] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button81.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f81] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button82.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f82] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button83.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f83] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button84.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f84] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button85.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f85] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button86.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f86] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button87.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f87] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button88.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f88] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button89.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f89] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button90.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f90] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button91.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f91] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button92.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f92] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button93.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f93] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button94.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f94] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button95.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f95] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button96.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f96] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button97.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f97] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button98.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f98] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button99.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f99] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button100.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f100] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button101.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f101] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button102.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f102] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button103.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f103] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button104.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f104] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button105.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f105] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button106.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f106] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button107.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f107] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button108.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f108] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button109.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f109] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button110.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f110] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button111.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f111] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button112.BackColor = Color.BlueViolet Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [f112] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button113.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s1] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button114.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s2] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button115.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s3] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button116.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s4] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button117.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s5] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button118.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s6] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button119.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s7] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button120.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s8] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button121.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s9] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button122.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s10] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button123.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s11] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button124.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s12] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button125.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s13] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button126.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s14] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button127.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s15] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button128.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s16] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button129.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s17] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button130.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s18] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button131.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s19] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button132.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s20] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button133.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s21] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button134.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s22] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button135.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s23] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button136.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s24] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button137.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s25] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button138.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s26] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button139.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s27] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button140.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s28] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button141.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s29] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button142.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s30] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button143.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s31] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button144.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s32] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button145.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s33] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button146.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s34] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button147.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s35] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button148.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s36] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button149.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s37] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button150.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s38] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button151.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s39] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button152.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s40] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button153.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s41] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button154.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s42] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button155.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s43] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button156.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s44] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button157.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s45] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button158.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s46] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button159.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s47] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button160.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [s48] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button161.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b1] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button162.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b2] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button163.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b3] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button164.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b4] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button165.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b5] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button166.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b6] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button167.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b7] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button168.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b8] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button169.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b9] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button170.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b10] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button171.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b11] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button172.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b12] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button173.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b13] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button174.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b14] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button175.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b15] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button176.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b16] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button177.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b17] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button178.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b18] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button179.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b19] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button180.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b20] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button181.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b21] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button182.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b22] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button183.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b23] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button184.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b24] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button185.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b25] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button186.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b26] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button187.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b27] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "BALCONY"
            cmd = New OleDbCommand(co)
        ...
        If Button188.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b28] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button189.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b29] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button190.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b30] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button191.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b31] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button192.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b32] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button193.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b33] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button194.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b34] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button195.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b35] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button196.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b36] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button197.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b37] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button198.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b38] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button199.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b39] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button200.BackColor = Color.Blue Then
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab] set [b40] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        Try
            ...
            con.Open()
            Dim stime As String = "11:30 am"
            Dim stype As String = "NOON SHOW"
        ...
        Else
            ...
            Try
                ...
                e_mail.Subject = "RESERVATION DETAILS  -  NOON SHOW "
