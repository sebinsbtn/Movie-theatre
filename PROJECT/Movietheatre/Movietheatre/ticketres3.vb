...
Public Class ticketres3
    ...
    Private Sub ticketres_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        con.Open()
        Dim str11 As String = "select * from [moviereg] where [Movie name]='" & Label45.Text & "'"
        ...
        If reader11.Read() Then
            lang = reader11.GetValue(6)
            ' MessageBox.Show("language get", "Done", MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
        End If
        con.Close()

        Dim resread As OleDbDataReader = Nothing
        Dim rescon As OleDbConnection = Nothing
        Dim rescmd As OleDbCommand = Nothing
        Dim resnum As Integer = 0
        Dim resstr As String = "select max(res_id) from [resdetails]"
        rescmd = New OleDbCommand(resstr)
        rescon = New OleDbConnection(ck)
        rescon.Open()
        rescmd.Connection = rescon
        resnum = rescmd.ExecuteScalar

        TextBox8.Text = resnum + 1
        rescon.Close()



        Me.TextBox3.Text = Format(resselect.passdate, "MM/dd/yyyy")
        TextBox3.Visible = False
        Me.TextBox4.Text = resselect.passdate
        Dim rdrr As OleDbDataReader = Nothing
        Dim comd As OleDbCommand = Nothing
        con = New OleDbConnection(ck)
        con.Open()
        Dim str As String = "select * from [price] where [Current date]=#" & TextBox3.Text & "#"
        comd = New OleDbCommand(str)
        comd.Connection = con
        Dim reader As OleDbDataReader = Nothing
        reader = comd.ExecuteReader()
        If reader.Read() Then
            If Form3.checkreserve = 1 Then
            ...
            Else
                bprice = reader.GetValue(1)
                fprice = reader.GetValue(2)
                sprice = reader.GetValue(3)
            End If
        End If
        con.Close()
        ...
        con.Open()
        Dim ct As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f1]= -1 "
        Dim ct1 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f2]= -1 "
        Dim ct2 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f3]= -1 "
        Dim ct3 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f4]= -1 "
        Dim ct4 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f5]= -1 "
        Dim ct5 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f6]= -1 "
        Dim ct6 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f7]= -1 "
        Dim ct7 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f8]= -1 "
        Dim ct8 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f9]= -1 "
        Dim ct9 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f10]= -1 "
        Dim ct10 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f11]= -1 "
        Dim ct11 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f12]= -1 "
        Dim ct12 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f13]= -1 "
        Dim ct13 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f14]= -1 "
        Dim ct14 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f15]= -1 "
        Dim ct15 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f16]= -1 "
        Dim ct16 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f17]= -1 "
        Dim ct17 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f18]= -1 "
        Dim ct18 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f19]= -1 "
        Dim ct19 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f20]= -1 "
        Dim ct20 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f21]= -1 "
        Dim ct21 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f22]= -1 "
        Dim ct22 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f23]= -1 "
        Dim ct23 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f24]= -1 "
        Dim ct24 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f25]= -1 "
        Dim ct25 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f26]= -1 "
        Dim ct26 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f27]= -1 "
        Dim ct27 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f28]= -1 "
        Dim ct28 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f29]= -1 "
        Dim ct29 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f30]= -1 "
        Dim ct30 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f31]= -1 "
        Dim ct31 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f32]= -1 "
        Dim ct32 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f33]= -1 "
        Dim ct33 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f34]= -1 "
        Dim ct34 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f35]= -1 "
        Dim ct35 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f36]= -1 "
        Dim ct36 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f37]= -1 "
        Dim ct37 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f38]= -1 "
        Dim ct38 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f39]= -1 "
        Dim ct39 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f40]= -1 "
        Dim ct40 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f41]= -1 "
        Dim ct41 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f42]= -1 "
        Dim ct42 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f43]= -1 "
        Dim ct43 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f44]= -1 "
        Dim ct44 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f45]= -1 "
        Dim ct45 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f46]= -1 "
        Dim ct46 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f47]= -1 "
        Dim ct47 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f48]= -1 "
        Dim ct48 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f49]= -1 "
        Dim ct49 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f50]= -1 "
        Dim ct50 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f51]= -1 "
        Dim ct51 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f52]= -1 "
        Dim ct52 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f53]= -1 "
        Dim ct53 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f54]= -1 "
        Dim ct54 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f55]= -1 "
        Dim ct55 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f56]= -1 "
        Dim ct56 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f57]= -1 "
        Dim ct57 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f58]= -1 "
        Dim ct58 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f59]= -1 "
        Dim ct59 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f60]= -1 "
        Dim ct60 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f61]= -1 "
        Dim ct61 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f62]= -1 "
        Dim ct62 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f63]= -1 "
        Dim ct63 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f64]= -1 "
        Dim ct64 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f65]= -1 "
        Dim ct65 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f66]= -1 "
        Dim ct66 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f67]= -1 "
        Dim ct67 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f68]= -1 "
        Dim ct68 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f69]= -1 "
        Dim ct69 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f70]= -1 "
        Dim ct70 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f71]= -1 "
        Dim ct71 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f72]= -1 "
        Dim ct72 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f73]= -1 "
        Dim ct73 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f74]= -1 "
        Dim ct74 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f75]= -1 "
        Dim ct75 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f76]= -1 "
        Dim ct76 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f77]= -1 "
        Dim ct77 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f78]= -1 "
        Dim ct78 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f79]= -1 "
        Dim ct79 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f80]= -1 "
        Dim ct80 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f81]= -1 "
        Dim ct81 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f82]= -1 "
        Dim ct82 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f83]= -1 "
        Dim ct83 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f84]= -1 "
        Dim ct84 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f85]= -1 "
        Dim ct85 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f86]= -1 "
        Dim ct86 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f87]= -1 "
        Dim ct87 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f88]= -1 "
        Dim ct88 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f89]= -1 "
        Dim ct89 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f90]= -1 "
        Dim ct90 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f91]= -1 "
        Dim ct91 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f92]= -1 "
        Dim ct92 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f93]= -1 "
        Dim ct93 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f94]= -1 "
        Dim ct94 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f95]= -1 "
        Dim ct95 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f96]= -1 "
        Dim ct96 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f97]= -1 "
        Dim ct97 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f98]= -1 "
        Dim ct98 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f99]= -1 "
        Dim ct99 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f100]= -1 "
        Dim ct100 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f101]= -1 "
        Dim ct101 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f102]= -1 "
        Dim ct102 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f103]= -1 "
        Dim ct103 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f104]= -1 "
        Dim ct104 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f105]= -1 "
        Dim ct105 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f106]= -1 "
        Dim ct106 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f107]= -1 "
        Dim ct107 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f108]= -1 "
        Dim ct108 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f109]= -1 "
        Dim ct109 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f110]= -1 "
        Dim ct110 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f111]= -1 "
        Dim ct111 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [f112]= -1 "
        Dim ct112 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s1]= -1 "
        Dim ct113 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s2]= -1 "
        Dim ct114 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s3]= -1 "
        Dim ct115 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s4]= -1 "
        Dim ct116 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s5]= -1 "
        Dim ct117 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s6]= -1 "
        Dim ct118 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s7]= -1 "
        Dim ct119 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s8]= -1 "
        Dim ct120 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s9]= -1 "
        Dim ct121 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s10]= -1 "
        Dim ct122 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s11]= -1 "
        Dim ct123 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s12]= -1 "
        Dim ct124 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s13]= -1 "
        Dim ct125 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s14]= -1 "
        Dim ct126 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s15]= -1 "
        Dim ct127 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s16]= -1 "
        Dim ct128 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s17]= -1 "
        Dim ct129 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s18]= -1 "
        Dim ct130 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s19]= -1 "
        Dim ct131 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s20]= -1 "
        Dim ct132 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s21]= -1 "
        Dim ct133 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s22]= -1 "
        Dim ct134 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s23]= -1 "
        Dim ct135 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s24]= -1 "
        Dim ct136 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s25]= -1 "
        Dim ct137 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s26]= -1 "
        Dim ct138 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s27]= -1 "
        Dim ct139 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s28]= -1 "
        Dim ct140 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s29]= -1 "
        Dim ct141 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s30]= -1 "
        Dim ct142 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s31]= -1 "
        Dim ct143 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s32]= -1 "
        Dim ct144 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s33]= -1 "
        Dim ct145 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s34]= -1 "
        Dim ct146 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s35]= -1 "
        Dim ct147 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s36]= -1 "
        Dim ct148 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s37]= -1 "
        Dim ct149 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s38]= -1 "
        Dim ct150 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s39]= -1 "
        Dim ct151 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s40]= -1 "
        Dim ct152 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s41]= -1 "
        Dim ct153 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s42]= -1 "
        Dim ct154 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s43]= -1 "
        Dim ct155 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s44]= -1 "
        Dim ct156 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s45]= -1 "
        Dim ct157 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s46]= -1 "
        Dim ct158 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s47]= -1 "
        Dim ct159 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [s48]= -1 "
        Dim ct160 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b1]= -1 "
        Dim ct161 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b2]= -1 "
        Dim ct162 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b3]= -1 "
        Dim ct163 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b4]= -1 "
        Dim ct164 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b5]= -1 "
        Dim ct165 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b6]= -1 "
        Dim ct166 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b7]= -1 "
        Dim ct167 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b8]= -1 "
        Dim ct168 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b9]= -1 "
        Dim ct169 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b10]= -1 "
        Dim ct170 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b11]= -1 "
        Dim ct171 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b12]= -1 "
        Dim ct172 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b13]= -1 "
        Dim ct173 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b14]= -1 "
        Dim ct174 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b15]= -1 "
        Dim ct175 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b16]= -1 "
        Dim ct176 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b17]= -1 "
        Dim ct177 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b18]= -1 "
        Dim ct178 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b19]= -1 "
        Dim ct179 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b20]= -1 "
        Dim ct180 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b21]= -1 "
        Dim ct181 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b22]= -1 "
        Dim ct182 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b23]= -1 "
        Dim ct183 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b24]= -1 "
        Dim ct184 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b25]= -1 "
        Dim ct185 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b26]= -1 "
        Dim ct186 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b27]= -1 "
        Dim ct187 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b28]= -1 "
        Dim ct188 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b29]= -1 "
        Dim ct189 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b30]= -1 "
        Dim ct190 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b31]= -1 "
        Dim ct191 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b32]= -1 "
        Dim ct192 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b33]= -1 "
        Dim ct193 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b34]= -1 "
        Dim ct194 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b35]= -1 "
        Dim ct195 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b36]= -1 "
        Dim ct196 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b37]= -1 "
        Dim ct197 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b38]= -1 "
        Dim ct198 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b39]= -1 "
        Dim ct199 As String = "select * from [reservetab3] where resDate=#" & TextBox3.Text & "# AND [b40]= -1 "
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Button1.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If Button2.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        If Button9.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        If Button5.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button17_Click(sender As Object, e As EventArgs) Handles Button17.Click
        If Button17.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button13_Click(sender As Object, e As EventArgs) Handles Button13.Click
        If Button13.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button21_Click(sender As Object, e As EventArgs) Handles Button21.Click
        If Button21.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button10_Click(sender As Object, e As EventArgs) Handles Button10.Click
        If Button10.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button25_Click(sender As Object, e As EventArgs) Handles Button25.Click
        If Button25.BackColor = Color.BlueViolet Then
            Button25.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button25.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If Button3.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button29_Click(sender As Object, e As EventArgs) Handles Button29.Click
        If Button29.BackColor = Color.BlueViolet Then
            Button29.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button29.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button33_Click(sender As Object, e As EventArgs) Handles Button33.Click
        If Button33.BackColor = Color.BlueViolet Then
            Button33.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button33.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button18_Click(sender As Object, e As EventArgs) Handles Button18.Click
        If Button18.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button37_Click(sender As Object, e As EventArgs) Handles Button37.Click
        If Button37.BackColor = Color.BlueViolet Then
            Button37.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button37.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button14_Click(sender As Object, e As EventArgs) Handles Button14.Click
        If Button14.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button41_Click(sender As Object, e As EventArgs) Handles Button41.Click
        If Button41.BackColor = Color.BlueViolet Then
            Button41.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button41.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button22_Click(sender As Object, e As EventArgs) Handles Button22.Click
        If Button22.BackColor = Color.BlueViolet Then
            Button22.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button22.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button49_Click(sender As Object, e As EventArgs) Handles Button49.Click
        If Button49.BackColor = Color.BlueViolet Then
            Button49.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button49.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button45_Click(sender As Object, e As EventArgs) Handles Button45.Click
        If Button45.BackColor = Color.BlueViolet Then
            Button45.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button45.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button53_Click(sender As Object, e As EventArgs) Handles Button53.Click
        If Button53.BackColor = Color.BlueViolet Then
            Button53.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button53.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button26_Click(sender As Object, e As EventArgs) Handles Button26.Click
        If Button26.BackColor = Color.BlueViolet Then
            Button26.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button26.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button57_Click(sender As Object, e As EventArgs) Handles Button57.Click
        If Button57.BackColor = Color.BlueViolet Then
            Button57.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button57.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button30_Click(sender As Object, e As EventArgs) Handles Button30.Click
        If Button30.BackColor = Color.BlueViolet Then
            Button30.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button30.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button61_Click(sender As Object, e As EventArgs) Handles Button61.Click
        If Button61.BackColor = Color.BlueViolet Then
            Button61.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button61.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button34_Click(sender As Object, e As EventArgs) Handles Button34.Click
        If Button34.BackColor = Color.BlueViolet Then
            Button34.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button34.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button65_Click(sender As Object, e As EventArgs) Handles Button65.Click
        If Button65.BackColor = Color.BlueViolet Then
            Button65.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button65.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button38_Click(sender As Object, e As EventArgs) Handles Button38.Click
        If Button38.BackColor = Color.BlueViolet Then
            Button38.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button38.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button69_Click(sender As Object, e As EventArgs) Handles Button69.Click
        If Button69.BackColor = Color.BlueViolet Then
            Button69.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button69.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button42_Click(sender As Object, e As EventArgs) Handles Button42.Click
        If Button42.BackColor = Color.BlueViolet Then
            Button42.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button42.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button73_Click(sender As Object, e As EventArgs) Handles Button73.Click
        If Button73.BackColor = Color.BlueViolet Then
            Button73.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button73.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button46_Click(sender As Object, e As EventArgs) Handles Button46.Click
        If Button46.BackColor = Color.BlueViolet Then
            Button46.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button46.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button77_Click(sender As Object, e As EventArgs) Handles Button77.Click
        If Button77.BackColor = Color.BlueViolet Then
            Button77.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button77.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button50_Click(sender As Object, e As EventArgs) Handles Button50.Click
        If Button50.BackColor = Color.BlueViolet Then
            Button50.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button50.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button81_Click(sender As Object, e As EventArgs) Handles Button81.Click
        If Button81.BackColor = Color.BlueViolet Then
            Button81.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button81.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        If Button6.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button85_Click(sender As Object, e As EventArgs) Handles Button85.Click
        If Button85.BackColor = Color.BlueViolet Then
            Button85.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button85.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button89_Click(sender As Object, e As EventArgs) Handles Button89.Click
        If Button89.BackColor = Color.BlueViolet Then
            Button89.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button89.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button54_Click(sender As Object, e As EventArgs) Handles Button54.Click
        If Button54.BackColor = Color.BlueViolet Then
            Button54.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button54.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button93_Click(sender As Object, e As EventArgs) Handles Button93.Click
        If Button93.BackColor = Color.BlueViolet Then
            Button93.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button93.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button11_Click(sender As Object, e As EventArgs) Handles Button11.Click
        If Button11.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button97_Click(sender As Object, e As EventArgs) Handles Button97.Click
        If Button97.BackColor = Color.BlueViolet Then
            Button97.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button97.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button58_Click(sender As Object, e As EventArgs) Handles Button58.Click
        If Button58.BackColor = Color.BlueViolet Then
            Button58.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button58.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button101_Click(sender As Object, e As EventArgs) Handles Button101.Click
        If Button101.BackColor = Color.BlueViolet Then
            Button101.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button101.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        If Button7.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button105_Click(sender As Object, e As EventArgs) Handles Button105.Click
        If Button105.BackColor = Color.BlueViolet Then
            Button105.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button105.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button62_Click(sender As Object, e As EventArgs) Handles Button62.Click
        If Button62.BackColor = Color.BlueViolet Then
            Button62.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button62.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button109_Click(sender As Object, e As EventArgs) Handles Button109.Click
        If Button109.BackColor = Color.BlueViolet Then
            Button109.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button109.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button19_Click(sender As Object, e As EventArgs) Handles Button19.Click
        If Button19.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If Button4.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button12_Click(sender As Object, e As EventArgs) Handles Button12.Click
        If Button12.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button20_Click(sender As Object, e As EventArgs) Handles Button20.Click
        If Button20.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button24_Click(sender As Object, e As EventArgs) Handles Button24.Click
        If Button24.BackColor = Color.BlueViolet Then
            Button24.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button24.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button28_Click(sender As Object, e As EventArgs) Handles Button28.Click
        If Button28.BackColor = Color.BlueViolet Then
            Button28.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button28.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button32_Click(sender As Object, e As EventArgs) Handles Button32.Click
        If Button32.BackColor = Color.BlueViolet Then
            Button32.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button32.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button36_Click(sender As Object, e As EventArgs) Handles Button36.Click
        If Button36.BackColor = Color.BlueViolet Then
            Button36.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button36.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button40_Click(sender As Object, e As EventArgs) Handles Button40.Click
        If Button40.BackColor = Color.BlueViolet Then
            Button40.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button40.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button44_Click(sender As Object, e As EventArgs) Handles Button44.Click
        If Button44.BackColor = Color.BlueViolet Then
            Button44.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button44.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button52_Click(sender As Object, e As EventArgs) Handles Button52.Click
        If Button52.BackColor = Color.BlueViolet Then
            Button52.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button52.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button56_Click(sender As Object, e As EventArgs) Handles Button56.Click
        If Button56.BackColor = Color.BlueViolet Then
            Button56.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button56.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button60_Click(sender As Object, e As EventArgs) Handles Button60.Click
        If Button60.BackColor = Color.BlueViolet Then
            Button60.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button60.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button64_Click(sender As Object, e As EventArgs) Handles Button64.Click
        If Button64.BackColor = Color.BlueViolet Then
            Button64.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button64.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button68_Click(sender As Object, e As EventArgs) Handles Button68.Click
        If Button68.BackColor = Color.BlueViolet Then
            Button68.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button68.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button72_Click(sender As Object, e As EventArgs) Handles Button72.Click
        If Button72.BackColor = Color.BlueViolet Then
            Button72.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button72.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button76_Click(sender As Object, e As EventArgs) Handles Button76.Click
        If Button76.BackColor = Color.BlueViolet Then
            Button76.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button76.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button80_Click(sender As Object, e As EventArgs) Handles Button80.Click
        If Button80.BackColor = Color.BlueViolet Then
            Button80.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button80.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button84_Click(sender As Object, e As EventArgs) Handles Button84.Click
        If Button84.BackColor = Color.BlueViolet Then
            Button84.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button84.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button88_Click(sender As Object, e As EventArgs) Handles Button88.Click
        If Button88.BackColor = Color.BlueViolet Then
            Button88.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button88.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button92_Click(sender As Object, e As EventArgs) Handles Button92.Click
        If Button92.BackColor = Color.BlueViolet Then
            Button92.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button92.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button96_Click(sender As Object, e As EventArgs) Handles Button96.Click
        If Button96.BackColor = Color.BlueViolet Then
            Button96.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button96.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button100_Click(sender As Object, e As EventArgs) Handles Button100.Click
        If Button100.BackColor = Color.BlueViolet Then
            Button100.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button100.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button104_Click(sender As Object, e As EventArgs) Handles Button104.Click
        If Button104.BackColor = Color.BlueViolet Then
            Button104.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button104.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button108_Click(sender As Object, e As EventArgs) Handles Button108.Click
        If Button108.BackColor = Color.BlueViolet Then
            Button108.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button108.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button112_Click(sender As Object, e As EventArgs) Handles Button112.Click
        If Button112.BackColor = Color.BlueViolet Then
            Button112.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button112.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button48_Click(sender As Object, e As EventArgs) Handles Button48.Click
        If Button48.BackColor = Color.BlueViolet Then
            Button48.BackColor = Color.Gold
            first = first - 1
        Else
            first = first + 1
            Button48.BackColor = Color.BlueViolet
        End If
        TextBox1.Text = balcony + first + second
        TextBox2.Text = (balcony * bprice) + (first * fprice) + (second * sprice)
    End Sub
    Private Sub Button16_Click(sender As Object, e As EventArgs) Handles Button16.Click
        If Button16.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        If Button8.BackColor = Color.BlueViolet Then
    ...
    Private Sub Button201_Click(sender As Object, e As EventArgs) Handles Button201.Click
        ...
        con = New OleDbConnection(ck)
        con.Open()
        Dim ct As String = "select * from [DCR] where [currdate]=#" & TextBox3.Text & "#"
        ...
        If Form3.checkreserve = 1 Then
            balcony = balcony + rdr.GetValue(3)
            first = first + rdr.GetValue(11)
            second = second + rdr.GetValue(19)
            Dim co1 As String = "update [DCR] set [balcony3] = '" & balcony & "',[firstclass3] = '" & first & "',[second class3] = '" & second & "' where [currdate]=#" & TextBox3.Text & "#"
            cmd = New OleDbCommand(co1)
        Else
            balcony = balcony + rdr.GetValue(7)
            first = first + rdr.GetValue(15)
            second = second + rdr.GetValue(23)
            Dim co2 As String = "update [DCR] set [balcony33] = '" & balcony & "',[firstclass33] = '" & first & "',[second class33] = '" & second & "' where [currdate]=#" & TextBox3.Text & "#"
            cmd = New OleDbCommand(co2)
        End If
        ...
        Else
            MessageBox.Show("Something happened !", "Ticket", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
        con.Close()
        ...
        If Button1.BackColor = Color.BlueViolet Then
            Button1.Enabled = False
            Button1.BackColor = Color.Red
            emailstring = emailstring + "  C1"
            Dim updaterow As Integer = 0
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f1] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button2.BackColor = Color.BlueViolet Then
            ...
            Button2.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C2"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f2] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button3.BackColor = Color.BlueViolet Then
            ...
            Button3.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C3"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f3] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button4.BackColor = Color.BlueViolet Then
            ...
            Dim updaterow As Integer = 0
            seattype = "FIRST CLASS"
            emailstring = emailstring + "  C4"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f4] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button5.BackColor = Color.BlueViolet Then
            ...
            Button5.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C5"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f5] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button6.BackColor = Color.BlueViolet Then
            ...
            Button6.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C6"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f6] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button7.BackColor = Color.BlueViolet Then
            ...
            Button7.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C7"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f7] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button8.BackColor = Color.BlueViolet Then
            ...
            Button8.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C8"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f8] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button9.BackColor = Color.BlueViolet Then
            ...
            Button9.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D1"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f9] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button10.BackColor = Color.BlueViolet Then
            ...
            Button10.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D2"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f10] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button11.BackColor = Color.BlueViolet Then
            Button11.Enabled = False
            Button11.BackColor = Color.Red
            emailstring = emailstring + "  D3"
            Dim updaterow As Integer = 0
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f11] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button12.BackColor = Color.BlueViolet Then
            Button12.Enabled = False
            Button12.BackColor = Color.Red
            emailstring = emailstring + "  D4"
            Dim updaterow As Integer = 0
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f12] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button13.BackColor = Color.BlueViolet Then
            ...
            Button13.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D5"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f13] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button14.BackColor = Color.BlueViolet Then
            ...
            Button14.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D6"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f14] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button15.BackColor = Color.BlueViolet Then
            ...
            Button15.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D7"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f15] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button16.BackColor = Color.BlueViolet Then
            ...
            Button16.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D8"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f16] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button17.BackColor = Color.BlueViolet Then
            ...
            Button17.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E1"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f17] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button18.BackColor = Color.BlueViolet Then
            ...
            Button18.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E2"
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f18] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button19.BackColor = Color.BlueViolet Then
            ...
            Button19.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E3"
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f19] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button20.BackColor = Color.BlueViolet Then
            ...
            Button20.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E4"
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f20] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button21.BackColor = Color.BlueViolet Then
            ...
            Button21.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E5"
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f21] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button22.BackColor = Color.BlueViolet Then
            ...
            Button22.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E6"
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f22] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button23.BackColor = Color.BlueViolet Then
            ...
            Button23.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E7"
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f23] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button24.BackColor = Color.BlueViolet Then
            ...
            Button24.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E8"
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f24] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button25.BackColor = Color.BlueViolet Then
            ...
            Button25.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F1"
            seattype = "FIRST CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f25] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button26.BackColor = Color.BlueViolet Then
            ...
            Button26.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F2"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f26] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button27.BackColor = Color.BlueViolet Then
            ...
            Button27.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F3"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f27] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button28.BackColor = Color.BlueViolet Then
            ...
            Button28.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F4"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f28] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button29.BackColor = Color.BlueViolet Then
            ...
            Button29.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F5"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f29] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button30.BackColor = Color.BlueViolet Then
            ...
            Button30.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F6"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f30] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button31.BackColor = Color.BlueViolet Then
            ...
            Button31.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F7"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f31] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button32.BackColor = Color.BlueViolet Then
            ...
            Button32.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F8"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f32] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button33.BackColor = Color.BlueViolet Then
            ...
            Button33.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G1"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f33] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button34.BackColor = Color.BlueViolet Then
            ...
            Button34.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G2"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f34] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button35.BackColor = Color.BlueViolet Then
            ...
            Button35.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G3"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f35] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button36.BackColor = Color.BlueViolet Then
            ...
            Button36.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G4"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f36] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button37.BackColor = Color.BlueViolet Then
            ...
            Button37.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G5"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f37] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button38.BackColor = Color.BlueViolet Then
            ...
            Button38.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G6"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f38] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button39.BackColor = Color.BlueViolet Then
            ...
            Button39.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G7"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f39] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button40.BackColor = Color.BlueViolet Then
            ...
            Button40.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G8"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f40] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button41.BackColor = Color.BlueViolet Then
            ...
            Button41.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H1"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f41] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button42.BackColor = Color.BlueViolet Then
            ...
            Button42.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H2"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f42] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button43.BackColor = Color.BlueViolet Then
            ...
            Button43.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H3"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f43] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button44.BackColor = Color.BlueViolet Then
            ...
            Button44.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H4"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f44] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button45.BackColor = Color.BlueViolet Then
            ...
            Button45.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H5"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f45] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button46.BackColor = Color.BlueViolet Then
            ...
            Button46.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H6"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f46] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button47.BackColor = Color.BlueViolet Then
            ...
            Button47.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H7"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f47] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button48.BackColor = Color.BlueViolet Then
            ...
            Button48.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H8"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f48] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button49.BackColor = Color.BlueViolet Then
            ...
            Button49.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I1"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f49] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button50.BackColor = Color.BlueViolet Then
            ...
            Button50.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I2"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f50] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button51.BackColor = Color.BlueViolet Then
            ...
            Button51.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I3"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f51] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button52.BackColor = Color.BlueViolet Then
            ...
            Button52.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I4"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f52] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button53.BackColor = Color.BlueViolet Then
            ...
            Button53.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I5"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f53] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button54.BackColor = Color.BlueViolet Then
            ...
            Button54.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I6"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f54] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button55.BackColor = Color.BlueViolet Then
            ...
            Button55.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I7"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f55] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button56.BackColor = Color.BlueViolet Then
            ...
            Button56.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I8"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f56] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button57.BackColor = Color.BlueViolet Then
            ...
            Button57.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C9"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f57] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button58.BackColor = Color.BlueViolet Then
            ...
            Button58.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C10"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f58] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button59.BackColor = Color.BlueViolet Then
            ...
            Button59.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C11"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f59] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button60.BackColor = Color.BlueViolet Then
            ...
            Button60.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C12"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f60] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button61.BackColor = Color.BlueViolet Then
            ...
            Button61.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C13"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f61] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button62.BackColor = Color.BlueViolet Then
            ...
            Button62.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C14"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f62] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button63.BackColor = Color.BlueViolet Then
            ...
            Button63.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C15"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f63] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button64.BackColor = Color.BlueViolet Then
            ...
            Button64.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  C16"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f64] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button65.BackColor = Color.BlueViolet Then
            ...
            Button65.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D9"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f65] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button66.BackColor = Color.BlueViolet Then
            ...
            Button66.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D10"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f66] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button67.BackColor = Color.BlueViolet Then
            ...
            Button67.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D11"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f67] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button68.BackColor = Color.BlueViolet Then
            ...
            Button68.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D12"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f68] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button69.BackColor = Color.BlueViolet Then
            ...
            Button69.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D13"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f69] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button70.BackColor = Color.BlueViolet Then
            ...
            Button70.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D14"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f70] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button71.BackColor = Color.BlueViolet Then
            ...
            Button71.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D15"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f71] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button72.BackColor = Color.BlueViolet Then
            ...
            Button72.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  D16"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f72] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button73.BackColor = Color.BlueViolet Then
            ...
            Button73.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E9"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f73] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button74.BackColor = Color.BlueViolet Then
            ...
            Button74.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E10"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f74] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button75.BackColor = Color.BlueViolet Then
            ...
            Button75.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E11"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f75] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button76.BackColor = Color.BlueViolet Then
            ...
            Button76.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E12"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f76] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button77.BackColor = Color.BlueViolet Then
            ...
            Button77.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E13"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f77] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button78.BackColor = Color.BlueViolet Then
            ...
            Button78.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E14"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f78] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button79.BackColor = Color.BlueViolet Then
            ...
            Button79.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E15"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f79] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button80.BackColor = Color.BlueViolet Then
            ...
            Button80.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  E16"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f80] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button81.BackColor = Color.BlueViolet Then
            ...
            Button81.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F9"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f81] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button82.BackColor = Color.BlueViolet Then
            ...
            Button82.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F10"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f82] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button83.BackColor = Color.BlueViolet Then
            ...
            Button83.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F11"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f83] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button84.BackColor = Color.BlueViolet Then
            ...
            Button84.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F12"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f84] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button85.BackColor = Color.BlueViolet Then
            ...
            Button85.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F13"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f85] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button86.BackColor = Color.BlueViolet Then
            ...
            Button86.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F14"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f86] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button87.BackColor = Color.BlueViolet Then
            ...
            Button87.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F15"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f87] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button88.BackColor = Color.BlueViolet Then
            ...
            Button88.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  F16"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f88] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button89.BackColor = Color.BlueViolet Then
            ...
            Button89.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G9"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f89] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button90.BackColor = Color.BlueViolet Then
            ...
            Button90.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G10"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f90] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button91.BackColor = Color.BlueViolet Then
            ...
            Button91.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G11"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f91] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button92.BackColor = Color.BlueViolet Then
            ...
            Button92.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G12"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f92] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button93.BackColor = Color.BlueViolet Then
            ...
            Button93.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G13"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f93] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button94.BackColor = Color.BlueViolet Then
            ...
            Button94.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G14"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f94] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button95.BackColor = Color.BlueViolet Then
            ...
            Button95.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G15"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f95] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button96.BackColor = Color.BlueViolet Then
            ...
            Button96.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  G16"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f96] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button97.BackColor = Color.BlueViolet Then
            ...
            Button97.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H9"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f97] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button98.BackColor = Color.BlueViolet Then
            ...
            Button98.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H10"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f98] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button99.BackColor = Color.BlueViolet Then
            ...
            Button99.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H11"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f99] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button100.BackColor = Color.BlueViolet Then
            ...
            Button100.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H12"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f100] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button101.BackColor = Color.BlueViolet Then
            ...
            Button101.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H13"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f101] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button102.BackColor = Color.BlueViolet Then
            ...
            Button102.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H14"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f102] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button103.BackColor = Color.BlueViolet Then
            ...
            Button103.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H15"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f103] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button104.BackColor = Color.BlueViolet Then
            ...
            Button104.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  H16"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f104] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button105.BackColor = Color.BlueViolet Then
            ...
            Button105.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I9"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f105] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button106.BackColor = Color.BlueViolet Then
            ...
            Button106.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I10"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f106] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button107.BackColor = Color.BlueViolet Then
            ...
            Button107.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I11"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f107] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button108.BackColor = Color.BlueViolet Then
            ...
            Button108.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I12"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f108] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button109.BackColor = Color.BlueViolet Then
            ...
            Button109.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I13"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f109] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button110.BackColor = Color.BlueViolet Then
            ...
            Button110.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I14"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f110] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button111.BackColor = Color.BlueViolet Then
            ...
            Button111.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I15"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f111] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button112.BackColor = Color.BlueViolet Then
            ...
            Button112.BackColor = Color.Red
            Dim updaterow As Integer = 0
            emailstring = emailstring + "  I16"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [f112] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "FIRST CLASS"
            cmd = New OleDbCommand(co)
        ...
        If Button113.BackColor = Color.Blue Then
            Button113.Enabled = False
            emailstring = emailstring + "  J1"
            Button113.BackColor = Color.Red
            Dim updaterow As Integer = 0
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s1] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button114.BackColor = Color.Blue Then
            Button114.Enabled = False
            emailstring = emailstring + "  J2"
            Button114.BackColor = Color.Red
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s2] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button115.BackColor = Color.Blue Then
            Button115.Enabled = False
            emailstring = emailstring + "  J3"
            Button115.BackColor = Color.Red
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s3] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button116.BackColor = Color.Blue Then
            Button116.Enabled = False
            Button116.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  J4"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s4] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button117.BackColor = Color.Blue Then
            Button117.Enabled = False
            emailstring = emailstring + "  J5"
            Button117.BackColor = Color.Red
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s5] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button118.BackColor = Color.Blue Then
            Button118.Enabled = False
            emailstring = emailstring + "  J6"
            Button118.BackColor = Color.Red
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s6] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button119.BackColor = Color.Blue Then
            Button119.Enabled = False
            Button119.BackColor = Color.Red
            emailstring = emailstring + "  J7"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s7] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button120.BackColor = Color.Blue Then
            Button120.Enabled = False
            Button120.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  J8"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s8] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button121.BackColor = Color.Blue Then
            Button121.Enabled = False
            Button121.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  K1"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s9] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button122.BackColor = Color.Blue Then
            Button122.Enabled = False
            emailstring = emailstring + "  K2"
            Button122.BackColor = Color.Red
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s10] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button123.BackColor = Color.Blue Then
            Button123.Enabled = False
            Button123.BackColor = Color.Red
            emailstring = emailstring + "  K3"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s11] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button124.BackColor = Color.Blue Then
            Button124.Enabled = False
            Button124.BackColor = Color.Red
            emailstring = emailstring + "  K4"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s12] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button125.BackColor = Color.Blue Then
            Button125.Enabled = False
            Button125.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  K5"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s13] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button126.BackColor = Color.Blue Then
            Button126.Enabled = False
            Button126.BackColor = Color.Red
            emailstring = emailstring + "  K6"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s14] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button127.BackColor = Color.Blue Then
            Button127.Enabled = False
            Button127.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  K7"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s15] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button128.BackColor = Color.Blue Then
            Button128.Enabled = False
            Button128.BackColor = Color.Red
            emailstring = emailstring + "  K8"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s16] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button129.BackColor = Color.Blue Then
            Button129.Enabled = False
            Button129.BackColor = Color.Red
            emailstring = emailstring + "  L1"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s17] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button130.BackColor = Color.Blue Then
            Button130.Enabled = False
            Button130.BackColor = Color.Red
            emailstring = emailstring + "  L2"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s18] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button131.BackColor = Color.Blue Then
            Button131.Enabled = False
            Button131.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  L3"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s19] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button132.BackColor = Color.Blue Then
            Button132.Enabled = False
            Button132.BackColor = Color.Red

            emailstring = emailstring + "  L4"
            Dim updaterow As Integer = 0
            seattype = "SECOND CLASS"
            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s20] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button133.BackColor = Color.Blue Then
            Button133.Enabled = False
            Button133.BackColor = Color.Red
            emailstring = emailstring + "  L5"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s21] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button134.BackColor = Color.Blue Then
            Button134.Enabled = False
            Button134.BackColor = Color.Red
            emailstring = emailstring + "  L6"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s22] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button135.BackColor = Color.Blue Then
            Button135.Enabled = False
            Button135.BackColor = Color.Red
            emailstring = emailstring + "  L7"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s23] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button136.BackColor = Color.Blue Then
            Button136.Enabled = False
            Button136.BackColor = Color.Red
            emailstring = emailstring + "  L8"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s24] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button137.BackColor = Color.Blue Then
            Button137.Enabled = False
            Button137.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  J9"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s25] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button138.BackColor = Color.Blue Then
            Button138.Enabled = False
            Button138.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  J10"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s26] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button139.BackColor = Color.Blue Then
            Button139.Enabled = False
            Button139.BackColor = Color.Red
            emailstring = emailstring + "  J11"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s27] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button140.BackColor = Color.Blue Then
            Button140.Enabled = False
            Button140.BackColor = Color.Red
            emailstring = emailstring + "  J12"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s28] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button141.BackColor = Color.Blue Then
            Button141.Enabled = False
            Button141.BackColor = Color.Red
            emailstring = emailstring + "  J13"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s29] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button142.BackColor = Color.Blue Then
            Button142.Enabled = False
            Button142.BackColor = Color.Red
            emailstring = emailstring + "  J14"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s30] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button143.BackColor = Color.Blue Then
            Button143.Enabled = False
            Button143.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  J15"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s31] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button144.BackColor = Color.Blue Then
            Button144.Enabled = False
            Button144.BackColor = Color.Red
            emailstring = emailstring + "  J16"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s32] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button145.BackColor = Color.Blue Then
            Button145.Enabled = False
            Button145.BackColor = Color.Red
            emailstring = emailstring + "  K9"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s33] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button146.BackColor = Color.Blue Then
            Button146.Enabled = False
            Button146.BackColor = Color.Red
            emailstring = emailstring + "  K10"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s34] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button147.BackColor = Color.Blue Then
            Button147.Enabled = False
            Button147.BackColor = Color.Red
            emailstring = emailstring + "  K11"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s35] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button148.BackColor = Color.Blue Then
            Button148.Enabled = False
            Button148.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  K12"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s36] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button149.BackColor = Color.Blue Then
            Button149.Enabled = False
            Button149.BackColor = Color.Red
            emailstring = emailstring + "  K13"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s37] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button150.BackColor = Color.Blue Then
            Button150.Enabled = False
            Button150.BackColor = Color.Red
            emailstring = emailstring + "  K14"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s38] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button151.BackColor = Color.Blue Then
            Button151.Enabled = False
            Button151.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  K15"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s39] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button152.BackColor = Color.Blue Then
            Button152.Enabled = False
            Button152.BackColor = Color.Red
            emailstring = emailstring + "  K16"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s40] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button153.BackColor = Color.Blue Then
            Button153.Enabled = False
            Button153.BackColor = Color.Red
            emailstring = emailstring + "  L9"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s41] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button154.BackColor = Color.Blue Then
            Button154.Enabled = False
            Button154.BackColor = Color.Red
            emailstring = emailstring + "  L10"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s42] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button155.BackColor = Color.Blue Then
            Button155.Enabled = False
            Button155.BackColor = Color.Red
            emailstring = emailstring + "  L11"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s43] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button156.BackColor = Color.Blue Then
            Button156.Enabled = False
            Button156.BackColor = Color.Red
            emailstring = emailstring + "  L12"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s44] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button157.BackColor = Color.Blue Then
            Button157.Enabled = False
            Button157.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  L13"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s45] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button158.BackColor = Color.Blue Then
            Button158.Enabled = False
            Button158.BackColor = Color.Red
            seattype = "SECOND CLASS"
            emailstring = emailstring + "  L14"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s46] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button159.BackColor = Color.Blue Then
            Button159.Enabled = False
            Button159.BackColor = Color.Red
            emailstring = emailstring + "  L15"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s47] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        End If
        If Button160.BackColor = Color.Blue Then
            Button160.Enabled = False
            Button160.BackColor = Color.Red
            emailstring = emailstring + "  L16"
            seattype = "SECOND CLASS"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [s48] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button161.BackColor = Color.Blue Then
            Button161.Enabled = False
            Button161.BackColor = Color.Red
            emailstring = emailstring + "  A1"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b1] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            ...
            con.Close()
        End If
        If Button162.BackColor = Color.Blue Then
            Button162.Enabled = False
            Button162.BackColor = Color.Red
            emailstring = emailstring + "  A2"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b2] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button163.BackColor = Color.Blue Then
            Button163.Enabled = False
            Button163.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  A3"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b3] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button164.BackColor = Color.Blue Then
            Button164.Enabled = False
            Button164.BackColor = Color.Red
            emailstring = emailstring + "  A4"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b4] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button165.BackColor = Color.Blue Then
            Button165.Enabled = False
            Button165.BackColor = Color.Red
            emailstring = emailstring + "  A5"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b5] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button166.BackColor = Color.Blue Then
            Button166.Enabled = False
            Button166.BackColor = Color.Red
            emailstring = emailstring + "  A6"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b6] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button167.BackColor = Color.Blue Then
            Button167.Enabled = False
            Button167.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  A7"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b7] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button168.BackColor = Color.Blue Then
            Button168.Enabled = False
            Button168.BackColor = Color.Red
            emailstring = emailstring + "  A8"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b8] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button169.BackColor = Color.Blue Then
            Button169.Enabled = False
            Button169.BackColor = Color.Red
            emailstring = emailstring + "  B1"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b9] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button170.BackColor = Color.Blue Then
            Button170.Enabled = False
            Button170.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  B2"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b10] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button171.BackColor = Color.Blue Then
            Button171.Enabled = False
            Button171.BackColor = Color.Red
            emailstring = emailstring + "  B3"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b11] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button172.BackColor = Color.Blue Then
            Button172.Enabled = False
            Button172.BackColor = Color.Red
            emailstring = emailstring + "  B4"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b12] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button173.BackColor = Color.Blue Then
            Button173.Enabled = False
            Button173.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  B5"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b13] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button174.BackColor = Color.Blue Then
            Button174.Enabled = False
            Button174.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  B6"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b14] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button175.BackColor = Color.Blue Then
            Button175.Enabled = False
            Button175.BackColor = Color.Red
            emailstring = emailstring + "  B7"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b15] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button176.BackColor = Color.Blue Then
            Button176.Enabled = False
            Button176.BackColor = Color.Red
            emailstring = emailstring + "  B8"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b16] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button177.BackColor = Color.Blue Then
            Button177.Enabled = False
            Button177.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  A9"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b17] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button178.BackColor = Color.Blue Then
            Button178.Enabled = False
            Button178.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  A10"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b18] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button179.BackColor = Color.Blue Then
            Button179.Enabled = False
            emailstring = emailstring + "  A11"
            Button179.BackColor = Color.Red
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b19] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button180.BackColor = Color.Blue Then
            Button180.Enabled = False
            Button180.BackColor = Color.Red
            emailstring = emailstring + "  A12"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b20] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button181.BackColor = Color.Blue Then
            Button181.Enabled = False
            Button181.BackColor = Color.Red
            emailstring = emailstring + "  A13"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b21] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button182.BackColor = Color.Blue Then
            Button182.Enabled = False
            Button182.BackColor = Color.Red
            emailstring = emailstring + "  A14"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b22] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button183.BackColor = Color.Blue Then
            Button183.Enabled = False
            Button183.BackColor = Color.Red
            emailstring = emailstring + "  A15"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b23] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button184.BackColor = Color.Blue Then
            Button184.Enabled = False
            Button184.BackColor = Color.Red
            emailstring = emailstring + "  A16"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b24] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button185.BackColor = Color.Blue Then
            Button185.Enabled = False
            Button185.BackColor = Color.Red
            emailstring = emailstring + "  B9"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b25] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button186.BackColor = Color.Blue Then
            Button186.Enabled = False
            Button186.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  B10"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b26] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button187.BackColor = Color.Blue Then
            Button187.Enabled = False
            Button187.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  B11"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b27] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
            seattype = "BALCONY"
            cmd = New OleDbCommand(co)
        ...
        If Button188.BackColor = Color.Blue Then
            Button188.Enabled = False
            Button188.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  B12"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b28] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button189.BackColor = Color.Blue Then
            Button189.Enabled = False
            Button189.BackColor = Color.Red
            emailstring = emailstring + "  B13"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b29] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button190.BackColor = Color.Blue Then
            Button190.Enabled = False
            Button190.BackColor = Color.Red
            emailstring = emailstring + "  B14"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b30] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button191.BackColor = Color.Blue Then
            Button191.Enabled = False
            Button191.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  B15"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b31] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button192.BackColor = Color.Blue Then
            Button192.Enabled = False
            Button192.BackColor = Color.Red
            emailstring = emailstring + "  B16"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b32] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button193.BackColor = Color.Blue Then
            Button193.Enabled = False
            Button193.BackColor = Color.Red
            emailstring = emailstring + "  A17"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b33] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button194.BackColor = Color.Blue Then
            Button194.Enabled = False
            Button194.BackColor = Color.Red
            emailstring = emailstring + "  A18"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b34] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button195.BackColor = Color.Blue Then
            Button195.Enabled = False
            Button195.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  A19"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b35] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button196.BackColor = Color.Blue Then
            Button196.Enabled = False
            Button196.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  A20"
            Dim updaterow As Integer = 0

            Dim newpa As Integer = -1
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b36] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button197.BackColor = Color.Blue Then
            Button197.Enabled = False
            Button197.BackColor = Color.Red
            emailstring = emailstring + "  B17"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b37] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button198.BackColor = Color.Blue Then
            Button198.Enabled = False
            Button198.BackColor = Color.Red
            emailstring = emailstring + "  B18"
            seattype = "BALCONY"
            Dim updaterow As Integer = 0
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b38] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button199.BackColor = Color.Blue Then
            Button199.Enabled = False
            Button199.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  B19"
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b39] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        If Button200.BackColor = Color.Blue Then
            Button200.Enabled = False
            Button200.BackColor = Color.Red
            seattype = "BALCONY"
            emailstring = emailstring + "  B20"
            ...
            con = New OleDbConnection(ck)
            con.Open()
            Dim co As String = "update [reservetab3] set [b40] = '" & newpa & "' where [resDate]=#" & TextBox3.Text & "#"
        ...
        Try
            ...
            con = New OleDbConnection(ck)
            Dim updaterow2 As Integer = 0
            con.Open()
            Dim stime As String = "6 :00 pm"
            Dim stype As String = "SECOND SHOW"
            Dim co3 As String = "insert into [resdetails]([res_id],[Resname],[Movie name],[seat numbers],[language],[show date],[show time],[show type],[seat class],[unit price],[number of tickets],[total amount]) values('" & TextBox8.Text & "','" & TextBox7.Text & "','" & Label45.Text & "', '" & emailstring & "','" & lang & "','" & TextBox4.Text & "','" & stime & "','" & stype & "','" & seattype & "','" & fprice & "','" & TextBox1.Text & "','" & TextBox2.Text & "')"

            cmd = New OleDbCommand(co3)

            cmd.Connection = con
            updaterow2 = cmd.ExecuteNonQuery()
            If updaterow2 > 0 Then
                MessageBox.Show("Reservation details saved  !", "Ticket", MessageBoxButtons.OK, MessageBoxIcon.Information)

            Else
                MessageBox.Show("Error in reservation !", "Ticket", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error in saving data", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
        ...
        Else
            ...
            Try
                ...
                e_mail.Subject = "RESERVATION DETAILS  -   FIRST SHOW "
                e_mail.IsBodyHtml = False
                e_mail.Body = emailstring
        ...
        Else
            ...
            sURL = "http://api.mVaayoo.com/mvaayooapi/MessageCompose?user=sebin.sbtn@gmail.com:7034311551&senderID=TEST SMS&receipientno=+91" & TextBox6.Text & "&msgtype=4&dcs=8&ishex=1&msgtxt=your id is '" & resnum & "'  &state=1 "
   ...
   Private Sub Button113_Click(sender As Object, e As EventArgs) Handles Button113.Click
    ...
    Private Sub Button203_Click_1(sender As Object, e As EventArgs) Handles Button203.Click

    End Sub

    Private Sub Button201_Click_1(sender As Object, e As EventArgs)
